...
print_procesing "Generating urn-catalog in container\n"
misc_path=$1
...
print_procesing "Replacing paths: '$WORKDIR_PHP -> $absolute_host_dir'"
$COMMAND_BIN_NAME exec sh -c "sed -i s#${WORKDIR_PHP}#${absolute_host_dir}#g $misc_path"

print_procesing "Copying generated urn from container into host"
