---
description: "Define an iteration on the current feature \u2014 analyze the change\
  \ request against current spec state and implementation progress, then write a reviewable\
  \ iteration plan."
handoffs:
